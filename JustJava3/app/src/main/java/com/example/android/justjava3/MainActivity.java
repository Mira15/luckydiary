...
public class MainActivity extends AppCompatActivity {
    ...
    public void increment(View view) {
        if (quantity == 100) {
            ...
            Toast.makeText(this, "You can not have more than a 100 coffees.", Toast.LENGTH_SHORT).show();
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.android.justjava3/http/host/path")
        );
